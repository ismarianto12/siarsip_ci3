...
class Lokasi_model extends CI_Model
{
    ...
    function json()
    {
        $this->datatables->select('id_lokasi,nama_lokasi,date_format(tanggal,"%Y-%M-%d") as tanggal');
        ...
        <button to='" . site_url('lokasi/edit/$1') . "' id='edit' class='btn btn-warning btn-xs edit><i class='fa fa-trash'></i> Edit</button>
