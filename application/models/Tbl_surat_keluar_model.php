...
class Tbl_surat_keluar_model extends CI_Model
{
    ...
    function json()
    {
        ...
        $this->datatables->add_column('data_file', '<a href="' . base_url('sppdprint/download?file=assets/file_surat/$1') . '" class="btn bg-navy btn-flat margin btn-xs btn-xs" target="_blank">Lihat file</a>', 'file');
