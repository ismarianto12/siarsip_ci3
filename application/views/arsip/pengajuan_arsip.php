      ...
      <div class='table-responsive'>
       ...
       $.dialog({
        ...
        <?php } elseif ($form == 'y') {  ?>
          ...
          <br />
          <center>
            <div class="callout callout-info">Pejabat pembuat pengajuan arsip saat ini atas nama : <?= $this->session->nama ?></div>
          </center>
          <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label class="col-sm-3"><b>Tujuan Pengajuan</b></label>
              <div class="col-sm-3">
                <br /><textarea name="tujuan" class="form-control"> <?= $tujuan ?></textarea>
              </div>
            </div>
        ...
        <?php } elseif ($form == 'detail') {  ?>
          ...
          <table class="table table-striped">
            <tr>
              <th>Nama Arsip</th>
              <td><?php echo $sql->row()->nama_arsip; ?></td>
            </tr>
            <tr>
              <th>Jumlah /Satuan</th>
              <td><?php echo $sql->row()->jumlah . '/' . $sql->row()->satuan; ?></td>
            </tr>
            <tr>
              <th>Jujuan</th>
              <td><?php echo $sql->row()->tujuan; ?></td>
            </tr>
            <tr>
              <th>Tanggal</th>
              <td><?= tgl_indonesia($sql->row()->tanggal); ?></td>
            </tr>
            <tr>
              <th>File</th>
              <td><?= $data = ($sql->row()->file_arsip) ? $sql->row()->file_arsip : ''; ?></td>
            </tr>
            <tr>
              <th>Diajukan oleh</th>
              <td><?= $Nm = ($sql->row()->nama) ? $sql->row()->nama : 'Tidak ada nama'; ?></td>
            </tr>
          </table>
          <br />
