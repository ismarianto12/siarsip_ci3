...
<div class='panel-wrapper collapse in' aria-expanded='true'>
     ...
     ** ) Harap Isikan data yang di butuhkan pada form.
	 ...
	 <div class="form-group">
            <label for="varchar" class='control-label col-md-3'><b>Created By<?php echo form_error('created_by') ?></b></label>
            <div class='col-md-9'>
            <input type="text" class="form-control" name="created_by" id="created_by" placeholder="Created By" value="<?php echo $created_by; ?>" />
        </div>
    </div>
	 <div class="form-group">
            <label for="varchar" class='control-label col-md-3'><b>Creation Date<?php echo form_error('creation_date') ?></b></label>
            <div class='col-md-9'>
            <input type="text" class="form-control" name="creation_date" id="creation_date" placeholder="Creation Date" value="<?php echo $creation_date; ?>" />
        </div>
    </div>
	 <div class="form-group">
            <label for="varchar" class='control-label col-md-3'><b>Last Updated By<?php echo form_error('last_updated_by') ?></b></label>
            <div class='col-md-9'>
            <input type="text" class="form-control" name="last_updated_by" id="last_updated_by" placeholder="Last Updated By" value="<?php echo $last_updated_by; ?>" />
        </div>
    </div>
	 <div class="form-group">
            <label for="varchar" class='control-label col-md-3'><b>Last Updated Date<?php echo form_error('last_updated_date') ?></b></label>
            <div class='col-md-9'>
            <input type="text" class="form-control" name="last_updated_date" id="last_updated_date" placeholder="Last Updated Date" value="<?php echo $last_updated_date; ?>" />
        </div>
    </div>
