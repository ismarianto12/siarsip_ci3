<div class='row'>
    <div class='col-md-12'>
        <div class='box-default'>
            <div class='panel-heading'><i class="fa fa-document"></i> Edit Profil</div>
                            ...
                            <div class='row'>
                                ...
                                <div class='col-md-6'>
                                    <div class='form-group'>
                                        ...
                                        <div class='col-md-9'>
                                            <input type='password' name="password_ul" id="password_ul" class='form-control' placeholder='Password..'>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                <div class='col-md-6'>
                                    <div class='form-group'>
                                        ...
                                        <div class='col-md-9'>
                                            <input type='text' name="nama" id="nama" class='form-control' placeholder='Password..' value="<?= $nama ?>">
                                        </div>
                                    </div>
                                </div>
