...
<section id="wrapper" class="login-register">
  <div class="login-box">
   ...
   <script type="text/javascript">
     $(function(){
      $('#lupa_password').click(function(e){
        e.preventDefault();
        $('#recoverform').show();
        $('#clogin').hide(); 
        $('#lupa_password').hide();
  ...
  <div class="white-box">
    <center> 
     ...
     <h3 class="box-title m-b-20">Aplikasi Kearsipan</h3>
     <br /><br />
   </center>
    ...
    <div class="form-group">
      <div class="col-md-12">
                      ...
                      <!--   <div class="row">
                        ...
                        <p><button id="lupa_password" class="btn btn-primary btn-xs">Reset Password</button></p>
                        <form class="form-horizontal" id="recoverform" style="display: none;">
                          <div class="form-group ">
                            <div class="col-xs-12">
                          ...
                          <div class="form-group text-center m-t-20">
                            <div class="col-xs-12">
                             ...
                             <button class="btn btn-primary btn-lg btn-block text-uppercase waves-effect waves-light" id="recoverform
                     ...
                     e.preventDefault();
                      $.ajax({  
                        ...
                        success:function(data){
                          if(data.respond == 1){ 
                          swal('keterangan','Informasi password sudah di kirim via Email','success');
                        }else{ 
                          swal('keterangan','email tidak di temukan','info');

                        }
                        },errror:function(data){
                         swal('keterangan','server dalam ganguan','errror');
                       }  
                     });
                    });
