...
<head>
    ...
    <title><?= ($judul) ? $judul : 'Learning Management System' ?></title>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                       Hy  <?= ucfirst($this->session->username) ?> - <?= ucfirst($this->session->level) ?>
...
<!-- aplikasi js -->
    <script src="<?= base_url() ?>assets/template/js/jquery.maskedinput.>min.js"></script>
    <script src="<?= base_url() ?>assets/template/js/jquery.number.js"></script
