...
--
-- Host: localhost:3306
-- Generation Time: Apr 13, 2020 at 01:50 PM
...
CREATE TABLE `arsip` (
  ...
  `file_arsip` varchar(50) NOT NULL,
...
INSERT INTO `instansi` (`nama_instansi`, `alamat_lengkap`, `telp`, `informasi`, `keterangan_situs`, `fax`, `npwp`, `logo`, `favicon`) VALUES
('Kantor Kementerian Agama Kota Madiun', 'Jalan Mayjend Panjaitan Nomor 3 Kota Madiun 63133, Telepon (0351) 462606 Email: kotamadiun@kemenag.go.id', '0351 462606', 'Selamat datang di sistem informasi arsip sistem ini bertujuan untuk mempermudah dalam pengarsipan data yang ada pada instansi .', 'siarsip.min1kotamadiun.sch.id', '0351 462606', '462606', '1586758632logo.png', '1586758632logo.jpg');
...
(1, '1', '', 'data siswa', '1', 'kosong', '2019-12-10', ' data ', 'peng_1575978902.pdf', '2', 'n');
...
--
ALTER TABLE `histori`
  MODIFY `id_histori` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=568;

--
-- AUTO_INCREMENT for table `jenis_arsip`
--
ALTER TABLE `jenis_arsip`
  MODIFY `id_jenis` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `pengajuan_arsip`
  MODIFY `id_pengajuan` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tbl_surat_masuk`
  MODIFY `id_surat` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;
COMMIT;
